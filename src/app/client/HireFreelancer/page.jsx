        ...
        <div className="w-full max-w-[90%] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1240px] 2xl:max-w-[1400px] mx-auto my-10 lg:my-20">
          <div className="flex flex-col gap-6 lg:gap-8">
            <div className="flex flex-col lg:flex-row gap-6 lg:justify-between">
              <h2 className="text-2xl lg:text-[44px] text-heading font-bold md:font-semibold">
                Finalize Your Hire
              </h2>
            ...
            <div className="bg-[#5BBB7B0D] py-4 px-2 md:py-5 md:px-6 border border-[#FAFAFA] rounded mt-2">
              <p className="text-primary font-medium text-xs md:text-base">Define terms, set payment details, and send the offer to Alishan Noor</p>
            </div>
