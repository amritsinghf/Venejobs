          ...
          <div className="flex justify-between items-center gap-2 py-5 px-7  sm:px-5 ">
            ...
            {menuOpen && (
              <>
                ...
                <div
                  className={`fixed top-0 right-0 lg:hidden h-full w-50 bg-white shadow-xl z-50 p-4 flex flex-col gap-4 transform transition-transform duration-300 ease-in-out ${
