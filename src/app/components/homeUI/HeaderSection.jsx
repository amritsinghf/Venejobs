    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-500 text-base 2xl:text-lg font-medium leading-7">
            ...
            <div className="flex justify-end gap-6 lg:gap-8">
                ...
                <Link
                    href=""
                    className="bg-white text-paragraph text-center w-[180px] md:w-44 h-12 sm:h-[50px] lg:h-13 font-semibold tracking-wide text-sm xl:text-base flex items-center justify-center rounded transition-all duration-300"
                    style={{
