  ...
  return (
    ...
    >
      ...
      <div className="pt-4 flex md:hidden items-center gap-6 w-full">
        <button className="bg-primary px-8 py-2 rounded text-white text-sm md:text-base font-semibold cursor-pointer">Invite</button>
        <button className="border border-[#FAFAFA] bg-white p-1 md:p-2 rounded-full text-primary text-xs md:text-base flex items-center gap-4 float-right" style={{ boxShadow: "2px 2px 50px 6px #0000000D" }}>
          <SvgIcon name="Heart" />
        </button>
      </div>
      {index !== total - 1 && <hr className="border-[#44444414] mt-4 lg:mt-6" />}
    </div>
  );
}
