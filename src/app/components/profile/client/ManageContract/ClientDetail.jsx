        ...
        <div className="w-full flex flex-col gap-6 md:gap-8">
          <div className="flex flex-col md:flex-row items-start gap-10 lg:justify-between">
            <h1 className="text-2xl lg:text-[32px] text-heading font-semibold tracking-normal">
              UX/UI Design for Consulting Website + WP Build
            </h1>
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-paragraph text-sm lg:text-lg font-normal">
              ...
              <div className="flex flex-row items-center gap-10">
                ...
                <p className="text-sm text-paragraph lg:text-[15px] font-medium">
                  – 8:10 am local time
                </p>
              </div>
            </div>
          ...
          <div className="flex">
            <div className="w-1/2 md:w-[60%] flex flex-col md:flex-row gap-10 lg:gap-20 md:border-r md:border-[#6666664D]">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-paragraph text-sm lg:text-lg font-medium">$1000</p>
              </div>
              <div className="flex flex-col gap-2">
                <h2 className="text-heading lg:text-2xl font-semibold">Secured Funds</h2>
                <p className="text-paragraph text-sm lg:text-lg font-medium">$180</p>
              </div>
            </div>
