      ...
      >
        ...
        <nav className="flex flex-col items-start  gap-4 sm:gap-3 mt-5">
          ...
          >
            <Link
              href={""}
              className="flex items-center gap-4  text-center text-2xl  px-4  font-medium  w-full border bg-primary text-white py-3 rounded-2xl"
            > 
          ...
          >
            <Link
              href={""}
              className="flex items-center gap-4  text-center text-2xl  px-4 font-medium text-paragraph w-full   py-3 rounded-2xl"
            >
          ...
          <div className="mt-20 flex flex-col gap-2">
            ...
            >
              <Button
                onClick={() => user_logout()}
                className="flex items-center  gap-5 text-2xl  px-4 font-medium  text-paragraph"
              >
                <SvgIcon name="Logout" />
                Sign Out
              </Button>
