            ...
            <div className="w-full flex flex-col lg:flex-row items-start lg:items-center rounded justify-between gap-6">
                ...
                <div className="flex items-center gap-6 w-full lg:w-auto">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <div className="flex flex-row sm:flex-row sm:items-center gap-2 lg:gap-4">
                            <h3 className="text-xl lg:text-2xl text-heading font-semibold tracking-normal">
                                Harnish
                            </h3>
                            <p className="bg-secondary text-white rounded-3xl border font-medium px-4 py-1 text-xs lg:text-sm w-fit">
                                Active Contract
                            </p>
                        </div>
