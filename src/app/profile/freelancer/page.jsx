            ...
            <nav className="hidden lg:flex lg:flex-col lg:gap-8  items-start  gap-1 border border-gray-300 rounded-2xl mb-4 p-5">
              <div className="flex flex-col gap-64 justify-between items-center w-full">
                <div className="flex flex-col gap-4 mt-10">
                  <div
                    role="button"
                    className="flex items-center justify-center w-full py-2 h-[45px] rounded-lg hover:bg-blue-gray-50 bg-secondary text-white"
                  >
                    <Link
                      href={""}
          ...
          >
            ...
            <nav className="flex flex-col items-start  gap-1">
              ...
              >
                <Link
                  href={""}
                  className="flex items-center gap-4 text-lg text-center px-3  w-full border bg-secondary text-white p-2 rounded-2xl"
                >
